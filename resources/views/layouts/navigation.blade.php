<nav x-data="{ open: false }" class="border-b border-black dark:border-gray-700" style="background-color: #D4A373;">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('add_articles')" :active="request()->routeIs('admin.Addarticles')">
                        {{ __('Add articles') }}
                    </x-nav-link>
