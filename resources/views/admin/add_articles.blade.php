{{-- resources/views/admin/add_articles.blade.php --}}
<x-app-layout>
    <x-slot name="header">
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('admin.articles.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" class="w-full p-2 border border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-600" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="content" id="content" rows="6" class="w-full p-2 border border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-600" required></textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="meta_title" id="meta_title" class="w-full p-2 border border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-600">
                        </div>

                        <!-- SEO Meta Content -->
                        <div class="mb-4">
                            <label for="meta_content" class="block text-gray-700 dark:text-gray-300">Meta Content</label>
                            <textarea name="meta_content" id="meta_content" rows="3" class="w-full p-2 border border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-600"></textarea>
                        </div>

                            <button type="submit" class="btn btn-primary" style="background-color: #D4A373; color: white; padding: 8px 16px; border: none; border-radius: 4px; font-weight: bold;">
                                Submit
                            </button>
                        </form>
